...
CannonDebugRenderer.prototype = {
  ...
  _createMesh(shape) {
    ...
    case CANNON.Shape.types.CONVEXPOLYHEDRON:
      ...
      //         let b = face[j];
      //         let c = face[j + 1];
      //         geo.faces.push(new this.THREE.Face3(a, b, c));
      //     }
      // }
      ...
      //         geometry.faces.push(new this.THREE.Face3(j, j + 1, j + 2));
      //     }
      ...
      //                 geometry.faces.push(new this.THREE.Face3(i, i + 1, i + 2));
      //             }
      //         }
      //     }
      //     geometry.computeBoundingSphere();
