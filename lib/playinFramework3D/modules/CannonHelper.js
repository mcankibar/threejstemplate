 ...
 * this.helper.addVisual(body, 0xFF0000);
 */
  ...
  shape2Mesh(body, castShadow, receiveShadow, material = this.defaultMaterial) {
    ...
    body.shapes.forEach(function (shape) {
      ...
      case CANNON.Shape.types.BOX:
        ...
        //     const geo = new THREE.ConvexGeometry();
        ...
        for (let xi = 0; xi < shape.data.length - 1; xi++) {
          for (let yi = 0; yi < shape.data[xi].length - 1; yi++) {
            for (let k = 0; k < 2; k++) {
              ...
              // geometry.faces.push(new THREE.Face(i, i + 1, i + 2));
            }
          }
        }
      ...
      case CANNON.Shape.types.TRIMESH:
        ...
        for (let i = 0; i < shape.indices.length / 3; i++) {
          ...
          //geometry.faces.push(new THREE.Face(j, j + 1, j + 2));
        }
        geometry.computeBoundingSphere();
        geometry.computeFaceNormals();
